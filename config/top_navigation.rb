  ...
  navigation.items do |primary|
    ...
    def walktree(db, parent)
      ...
      if sub_items.count > 0
        parent.item db.name, db.name, edit_category_path(db.id) do |s|
        ...
        parent.item db.name,db.name,edit_category_path(db.id)
      end
    end
    ...
    #dynamic pages menus
    Category.where(parent_id: '1').each do |category|
      if category.showHome
        walktree(category, primary)
      end
    end
