...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { item: @keyword.item, item_type: @keyword.item_type, keyword_type: @keyword.keyword_type, p_des: @keyword.p_des, p_image: @keyword.p_image, p_name: @keyword.p_name, p_price: @keyword.p_price }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { item: @keyword.item, item_type: @keyword.item_type, keyword_type: @keyword.keyword_type, p_des: @keyword.p_des, p_image: @keyword.p_image, p_name: @keyword.p_name, p_price: @keyword.p_price }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
